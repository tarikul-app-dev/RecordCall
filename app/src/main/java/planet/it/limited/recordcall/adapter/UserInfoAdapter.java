package planet.it.limited.recordcall.adapter;
...
import planet.it.limited.recordcall.util.CallLog;
    ...
    public View getView(final int position,  View convertView,  ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if(userNumber.length()>0){
               retNameFromNumber = getContactName(userNumber,mContext);
            }
...
//          holder.txvDuration.setText(String.format("%.2f", ((time / 1000) / 60)));
          ...
          boolean isOutging = userInfoModel.isOutgoing();
          Drawable inComingIcon = mContext.getResources().getDrawable(R.drawable.in_call);
          Drawable outgoingIcon = mContext.getResources().getDrawable(R.drawable.out_call);
          if(isOutging){
            holder.imgvInOutIcon.setImageDrawable(outgoingIcon);
          }else {
              holder.imgvInOutIcon.setImageDrawable(inComingIcon);
          }
    ...
    private ViewHolder createViewHolder(View v) {
        ...
        holder.imgvInOutIcon =(ImageView)v.findViewById(R.id.imv_incoming);
        return holder;
    }
    private   class ViewHolder {
        TextView txvUserName,txvDate,txvDuration;
        ImageView imgvInOutIcon;
